...
- **Flexible Signal Types**: Choose between **White Noise**, inaudible **Sub-Bass Tone (12 Hz)**, **Pink Noise**, **Brown Noise**, or inaudible **High-Frequency Tone (19.5 kHz)** for keep-alive playback.
...
| **Keep-alive signal type** | Select between **White Noise**, **Sub-Bass Tone (12 Hz)**, **Pink Noise**, **Brown Noise**, or **High-Frequency Tone (19.5 kHz)**. | **Sub-Bass Tone (12 Hz)** or **High-Frequency Tone (19.5 kHz)** for silent operation, **Pink/Brown Noise** for soft ambient sound. |
